...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/ben/catkin_ws/src/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/ben/catkin_ws/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/ben/catkin_ws/install)
...
if(NOT "/home/ben/catkin_ws/src/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/ben/catkin_ws/src/clear_costmap_recovery/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ben/catkin_ws/src/clear_costmap_recovery/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
